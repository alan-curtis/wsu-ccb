...
<li <?php post_class(ex_wptl_lightbox($full_content,$ID,'class'));?> id="<?php echo get_the_ID();?>!" <?php echo ex_wptl_lightbox($full_content,$ID,'data'); ?>>
    ...
    <div class="wpex-timeline-label">
        ...
        <div class="timeline-details">
			...
			?>
            <div class="hidden-date"><?php echo extl_dataes($wpex_sublabel,true);?></div>
            	...
            	<?php
					if(!(is_array($posttypes) && in_array($posttype,$posttypes))){
						...
						<span>
							...
							<?php echo extl_dataes($wpex_date);?>
							</time>
						</span>
						<?php
					}
            ...
            <div class="wptl-readmore"><a href="<?php echo extl_dataes($custom_link);?>" title="<?php the_title_attribute();?>"><?php echo exwptl_get_option('exwptl_text_ct','exwptl_advanced_options')!='' ? exwptl_get_option('exwptl_text_ct','exwptl_advanced_options') : esc_html__('Continue reading','wp-timeline');?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
