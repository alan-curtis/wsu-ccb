<?php
namespace Elementor;
if(!class_exists('WPTL_Infographics_Elementor_Widget')){
	class WPTL_Infographics_Elementor_Widget extends Widget_Base {
		public function get_name() {
			return 'wptl_infographics';
		}
		
		public function get_title() {
			return esc_html__( 'Timeline Infographics', 'wp-timeline');
		}
		...
		protected function _register_controls() {
			$this->start_controls_section(
				'wptl_infog_global_settings',
				[
					'label' 		=> esc_html__( 'Timeline Infographics', 'wp-timeline')
				]
			);
			$this->add_control(
				'style',
				[
					...
					'default'		=> '',
					'options'		=> array(
						'1' => esc_html__('Style 1', 'wp-timeline'),
			...
			$this->add_control(
				'meta_value',
				[
					'label'			=> esc_html__("Meta value", "wp-timeline"),
					'type'			=> Controls_Manager::TEXT,
					'default' => '',
			...
			$this->add_control(
				'active_filter',
				[
					'label'			=> esc_html__("Active filter", "wp-timeline"),
					'type'			=> Controls_Manager::TEXT,
					'default' => '',
			...
			$this->add_control(
				'class',
				[
					'label'			=> esc_html__("Css Class", "wp-timeline"),
					'type'			=> Controls_Manager::TEXT,
					'default' => '',
