...
function parse_wpex_timeline_horizontal_func($atts, $content){
	...
	if($rtl_mode=='yes'){ $wpex_rtl_mode ='yes';
            ...
            <ul class="horizontal-nav">
				<?php while($the_query->have_posts()){ $the_query->the_post();
                    ...
                    <li class="<?php echo 'ictl-'.get_the_ID();?>">
                    	<span class="tl-point"><?php echo extl_dataes($wpex_sublabel);?><i class="fa <?php echo esc_attr($icon);?>"></i></span>
                    	<?php 
