...
function parse_wpex_timeline_horizontal_multi_func($atts, $content){
	global $ID,$style,$posttype,$show_media,$show_label,$taxonomy,$full_content,$hide_thumb,$number_excerpt,$img_size,$back_p;
						...
						<?php while($the_query->have_posts()){ $the_query->the_post();
		                    ...
		                    <li class="<?php echo 'ictl-'.get_the_ID();?>">
		                        <span class="tl-point wpex_point">
		                            ...
		                            <?php echo extl_dataes($wpex_sublabel);?>
		                        </span>
	   ...
	   "params" => array(
		  array(
			 ...
			 "value" => array(
				...
				esc_html__('Style 7', 'wp-timeline') => '7',
			 ),
			 "description" => ''
		  ),
		  array(
