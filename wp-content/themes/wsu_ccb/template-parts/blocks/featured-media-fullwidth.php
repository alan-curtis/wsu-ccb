...
$inc = rand(999, 111);
$argss = $args['media_group_fullwidth'];
?>
<section class="featured-media container">
	<div class="row">
		<div class="img-block">
			<img class="w-100 thumb_<?php echo $inc; ?>" src="<?php echo $argss['image']['url']; ?>">
			<?php
			if (!empty($argss['video_embed_url'])) {

				$link = $argss['video_embed_url'];
